  ...
  const createRecipe = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_URL}/recipe-creator?ingredients=${encodeURIComponent(ingredients)}`
      );
      ...
      setError(
        `Failed to connect backend: ${err.message}`
      );
        ...
        !loading && (
          ...
          >
            ...
            <p>
              ...
              🍽️ No recipes created yet.
              Start by entering ingredients above!
